...
**NOTES and RESULES:**<BR>
  No input `regularMarketOpen` causes KeyError<BR><BR>
**TEST SCRIPT STEPS/RESULTS**
| **STEP** | **TEST STEP/INPUT** | **EXPECTED RESULTS** | **ACTUAL RESULTS** | **Requirements Validated** | **PASS/FAIL** |
| --- | --- | --- | --- | --- | --- |
|1.| Enter python test_info.py in command line | returns a dictionary with values of input dictionary | KeyError: 'regularMarketOpen' | | FAIL|
