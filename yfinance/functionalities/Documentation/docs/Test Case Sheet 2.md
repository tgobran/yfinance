...
| --- | --- | --- | --- | --- | --- |
|1.| Enter python test_info.py in command line | return a empty string with no input url; return a string begin with `logo.clearbit.com` with input url | KeyError: 'regularMarketOpen' | | PASS|
